...
<div x-data="{ modelOpen: false }" x-on:open-modal.window="$event.detail == '{{ $name }}' ? modelOpen = true : null"
   ...
   <div x-show="modelOpen" class="fixed inset-0 z-999 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
      aria-modal="true">
      <div class="flex items-start justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
         <div x-cloak @click="modelOpen = false" x-show="modelOpen"
            ...
            class="fixed inset-0 transition-opacity bg-slate-800 bg-opacity-80" aria-hidden="true"></div>
