          ...
          <li>
            <a class="cursor-pointer group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              ...
              <svg class="absolute right-4 top-1/2 -translate-y-1/2 fill-current"
                :class="{ 'rotate-180': (selected === 'manajement') }" width="20" height="20" viewBox="0 0 20 20"
            ...
            <div class="translate transform overflow-hidden" :class="(selected === 'manajement') ? 'block' :'hidden'">
