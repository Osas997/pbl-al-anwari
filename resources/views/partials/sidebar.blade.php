        ...
        <ul class="mb-6 flex flex-col gap-1.5">
          ...
          <li>
            <a class="cursor-pointer group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
              ...
              :class="{ 'bg-graydark dark:bg-meta-4': (selected === 'manajement') && (page === 'manajement') }">
              <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
              ...
              <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li>
                  <a wire:navigate
                    ...
                    href="{{ route('dashboard') }}" :class="page === 'ecommerce' && '!text-white'">Kamar
                  </a>
                </li>
                <li>
                  <a wire:navigate
                    class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                    href="{{ route('settings') }}" :class="page === 'settings' && '!text-white'">Dinyyah
                  </a>
                </li>
              </ul>
            </div>
