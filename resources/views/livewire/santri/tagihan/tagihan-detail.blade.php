    ...
    <section>
                ...
                <div class="w-full mt-2 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <p class="w-2/3 mx-4 text-sm md:text-md">
                            {{ $tagihan->jenis_tagihan == 'syahriyyah'
                                ? 'Syahriyyah ' . $tagihan->santri->syahriyyah->jenis_domisili
                                : 'Catering ' . $tagihan->santri->catering->jumlah_catering . ' Kali Makan' }}
                        </p>
                    </div>
                    <div class="flex px-2 py-2 gap-4 items-center">
                        <div class="flex w-1/3 justify-between me-2 items-center">
        ...
        @if ($isPending)
            <div class="py-2 mb-2 w-full">
                <div class="py-8 px-10 bg-white rounded-lg dark:bg-slate-600 ">
                    <p class="text-lg font-semibold text-center text-orange-600">Pembayaran Sudah Dilakukan Tunggu
                        Sampai
                    ...
                    <div class="py-8 px-10 bg-white rounded-lg dark:bg-slate-600 ">
                        ...
                        <div>
                            ...
                            <div class="my-2 py-2">
                                ...
                                <livewire:santri.pembayaran.pembayaran-create :tagihanId="$tagihan->id" :nominal="$tagihan->nominal" />
                            </div>
                        </div>
                    </div>
                </div>
