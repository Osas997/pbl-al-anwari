                    ...
                    <td class="px-6 py-4 flex justify-center">
                        <div class="text-center flex">
                            <a href="{{ route('santri-detail', $item->id) }}" wire:navigate
                                class="px-3 py-2 text-blue-600 transition-all ease-in-out duration-300 hover:bg-blue-600 hover:text-white rounded-xl"><svg
                            ...
                            <a x-on:click="$dispatch('update-santri', { santri_id: {{ $item->id }} })"
                                class="cursor-pointer px-3 py-2 text-blue-600 transition-all ease-in-out duration-300 hover:bg-blue-600 hover:text-white rounded-xl"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
