<div class="py-4 font-poppins" id="santri-table">
    <div class="flex flex-column sm:flex-row flex-wrap sm:space-y-0 items-end justify-between pb-4">
        <div class="sm:flex sm:items-center sm:ms-6 max-w-sm gap-4">
            <div class="mx-3">
    ...
    <div class="py-4 px-4 mt-4">
        {{ $santri->links(data: ['scrollTo' => '#santri-table']) }}
    </div>
