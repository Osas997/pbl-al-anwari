                ...
                <div
                    ...
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <a wire:navigate href="{{ route('santri-detail', $pembayaran->tagihan->santri->id) }}"
                            class="w-2/3 mx-4 text-sm md:text-md hover:underline cursor-pointer hover:text-blue-600">{{ $pembayaran->tagihan->santri->nama_santri }}</a>
                    </div>
                    <div class="flex px-2 py-2 gap-4 items-center">
                        <div class="flex w-1/3 justify-between me-2 items-center">
            ...
            <div class="w-full mt-2 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                <div class="flex px-2 py-2 gap-4 items-center">
                    ...
                    <a wire:navigate href="{{ route('tagihan-detail', $pembayaran->tagihan->id) }}"
                        ...
                        {{ $pembayaran->tagihan->jenis_tagihan == 'syahriyyah'
                            ? 'Syahriyyah ' . $pembayaran->tagihan->santri->syahriyyah->jenis_domisili
                            : 'Catering ' . $pembayaran->tagihan->santri->catering->jumlah_catering . ' Kali Makan' }}
                    </a>
                </div>
                <div class="flex px-2 py-2 gap-4 items-center">
                    <div class="flex w-1/3 justify-between me-2 items-center">
                ...
                <div class="flex px-2 py-2 gap-4 items-center">
                    ...
                    <p class="w-2/3 mx-4 text-sm md:text-md">
                        {{ $pembayaran->tagihan->tgl_tagihan->translatedFormat('d F
                                                                        Y') }}
                    </p>
                </div>
                <div class="flex px-2 py-2 gap-4 items-center">
            ...
            <div class="mb-4 py-6 px-10 bg-white rounded-lg dark:bg-slate-600 w-full">
                ...
                <div class="w-full mt-2 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    ...
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <p class="w-2/3 mx-4 text-sm md:text-md">
                            {{ $pembayaran->pembayaranBank->bankPondok->nomor_rekening }}</p>
                    </div>
                    ...
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <p class="w-2/3 mx-4 text-sm md:text-md">
                            {{ $pembayaran->pembayaranBank->bankPondok->nama_rekening }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-4 py-6 px-10 bg-white rounded-lg dark:bg-slate-600 w-full">
                ...
                <div class="w-full mt-2 text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                    ...
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <p class="w-2/3 mx-4 text-sm md:text-md">
                            {{ $pembayaran->pembayaranBank->bankSantri->nomor_rekening }}</p>
                    </div>
                    ...
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <p class="w-2/3 mx-4 text-sm md:text-md">
                            {{ $pembayaran->pembayaranBank->bankSantri->nama_rekening }}</p>
                    </div>
                </div>
            </div>
        @endif
                ...
                @if ($pembayaran->metode_pembayaran == 'transfer')
                    <div class="flex px-2 py-2 gap-4 items-center">
                        ...
                        <div class="w-2/3 mx-4 text-sm flex justify-start items-center gap-2">
                            ...
                            <x-button wire:click='unduhGambar' class="md:w-1/3 w-full max-w-sm bg-emerald-600">Unduh
                                Gambar
                            </x-button>
                        </div>
                    </div>
