<div>
    <x-modals name="edit-catering-modal" header="Edit Catering">
        <form class="space-y-4" wire:submit='update'>
            <div class="mb-3">
                <label for="jumlah_catering" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Jumlah Catering </label>
                <input type="text" id="jumlah_catering" wire:model="jumlah_catering"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                    placeholder="Masukkan Nama Kamar" required />
                @error('jumlah_catering')
